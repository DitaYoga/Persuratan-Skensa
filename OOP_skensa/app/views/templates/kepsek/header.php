...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            <li><a href="<?= BASEURL?>/kepsek"><i class="fa fa-home"></i>Home </a> </li>
            <li><a href="<?= BASEURL?>/kepsek/suratmasuk"><i class="fa fa-download"></i>Surat masuk </a> </li>

            <li><a href="<?= BASEURL?>/kepsek/profile/<?=$_SESSION['user']['user_id']?>"><i class="fa fa-user"></i>Profile </a> </li>
